...
public class UserInfoController {
	...
	@RequestMapping(value = "/study/user/logout")
	public String studylogout(HttpSession session, ModelMap model) {
		session.invalidate();
		model.addAttribute("msg", "로그아웃 완료");
		model.addAttribute("url", "/index.do");
		return "/redirect";
	}      
		@RequestMapping(value = "/quiz/user/logout")
	public String quizlogout(HttpSession session, ModelMap model) {
		session.invalidate();
		model.addAttribute("msg", "로그아웃 완료");
		model.addAttribute("url", "/index.do");
		return "/redirect";
	}     
		@RequestMapping(value = "/signBook/user/logout")
		public String signBooklogout(HttpSession session, ModelMap model) {
			session.invalidate();
			model.addAttribute("msg", "로그아웃 완료");
			model.addAttribute("url", "/index.do");
			return "/redirect";
		...
		@RequestMapping(value = "/notice/user/logout")
		public String noticelogout(HttpSession session, ModelMap model) {
			session.invalidate();
			model.addAttribute("msg", "로그아웃 완료");
			model.addAttribute("url", "/index.do");
			return "/redirect";
	...
	public String findPasswordProc(HttpServletRequest request, ModelMap model) throws Exception {
		...
		// 있을 경우
			...
			content.append("https://pasprj.paas-ta.org/user/findPasswordForm.do?code=");
