                    ...
                    <form action="/study/doEditStudyDetail.do" method="post">
                        ...
                        <div class="vw-ml-action-ls text-right mg-t-20">
                            <div class="btn-group ib-btn-gp active-hook nk-email-inbox">
                                <button style=" float: right;margin-right: 40px;background-color:#00c292;border: 0px;color:white;" type="submit" class="btn btn-default btn-sm waves-effect"><i class="fas fa-share"></i>수정하기</button>
                        </div>
                    </div>              
                </div>
                </form>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>
                     Copyright © 2020 . All rights reserved. Team FOMARD 
                  </p>
                    </div>
                </div>
            </div>
