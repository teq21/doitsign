...
<script type="text/javascript">
	...
	window.onload = function() {
		 swal("알려드립니다","https://pasprj.paas-ta.org로 접속하셔야 카메라가 작동됩니다", "info");
			...
			<div id="index" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
				...
				<h1>
					<a href="" class="typewrite" data-period="1000"
						data-type='[ "DO IT SIGN!", "모션인식을 활용한 ", "수화를  체험해보세요 " ]'> <span
						class="wrap"></span>
					</a>
				</h1>
				...
				<br> <br> <br> <br>
				<div class="b">
					<a href="/model.do" style="color: #0b7f62ab">지금 시작하기 ▶</a>
				</div>
			</div>
		</div>
	</div>
