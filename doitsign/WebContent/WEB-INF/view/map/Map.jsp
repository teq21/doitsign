...
.infowbox { background-color:#00c292; color: #fff;text-align: center; width:400px; }
...
<!-- 로고, 세션 적용한 상단 헤더 영역 시작 -->
   ...
   <!--네비게이션바 끝 (원래는 main menu area 임)  -->
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcomb-list" style="background: #fff;border-radius:40px;
    box-shadow: 0 6px 10px rgba(0,0,0,.08), 0 0 6px rgba(0,0,0,.05);
      transition: .3s transform cubic-bezier(.155,1.105,.295,1.12),.3s box-shadow,.3s -webkit-transform cubic-bezier(.155,1.105,.295,1.12);
  ">
  ...
  <div class="overflow" >
    ...
    <h3 style="color:#00c292; margin-left:150px;">수화센터 Map</h3>
    <div id="text-animate">
      <h3 >지도에서 내가 사는 구를 클릭하여</h3>
      <h3 ></h3>
      <h3 >우리동네 수화센터를 찾아보세요</h3>
    </div>
  </div>
</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="tooltips-inner">
						...
						<script>
							...
							var imageSrc = 'https://www.flaticon.com/svg/static/icons/svg/302/302836.svg', // 마커이미지의 주소입니다    
							...
							var positions = [
									{
										content : '<div class="infowbox">강남구수화통역센터 <br> 서울 강남구 학동로 343 강남포바빌딩 지하2층</div>',
										latlng : new kakao.maps.LatLng(
												37.517400, 127.040621)
									},
									{
										content : '<div class="infowbox">강북구수화통역센터 <br> 서울 강북구 도봉로 388 테마빌딩 5층</div>',
										latlng : new kakao.maps.LatLng(
												37.641333, 127.029658)
									},
									{
										content : '<div class="infowbox">강동구수화통역센터<br> 서울 강동구 성내로 52 성원빌딩 6층</div>',
										latlng : new kakao.maps.LatLng(
												37.528289, 127.125671)
									},
									{
										content : '<div class="infowbox">강서구수화통역센터 <br> 서울 강서구 발산로 40 농수산식품공사 강서지사 419호</div>',
										latlng : new kakao.maps.LatLng(
												37.554228, 126.822057)
									},
									{
										content : '<div class="infowbox">관악구수화통역센터 <br> 서울 관악구 쑥고개로 128 1층 </div>',
										latlng : new kakao.maps.LatLng(
												37.478654, 126.950667)
									},
									{
										content : '<div class="infowbox">광진구수화통역센터 <br> 서울 광진구 아차산로 417 3층  </div>',
										latlng : new kakao.maps.LatLng(
												37.538067, 127.088994)
									},
									{
										content : '<div class="infowbox ">구로구수화통역센터 <br> 서울 구로구 가마산로 272 4층(강서수도사업소 구로청사)</div>',
										latlng : new kakao.maps.LatLng(
												37.519562, 126.869786)
									},
									{
										content : '<div class="infowbox ">금천구수화통역센터 <br> 서울 금천구 시흥대로147길 30-15 2층 </div>',
										latlng : new kakao.maps.LatLng(
												37.474735, 126.896170)
									},
									{
										content : '<div class="infowbox">노원구수화통역센터 <br> 서울 노원구 상계로23길 17 2층</div>',
										latlng : new kakao.maps.LatLng(
												37.658776, 127.068506)
									},
									{
										content : '<div class="infowbox ">도봉구수화통역센터 <br> 서울 도봉구 마들로13길 153 옥산빌딩 4층</div>',
										latlng : new kakao.maps.LatLng(
												37.657014, 127.046206)
									},
									{
										content : '<div class="infowbox">동대문구수화통역센터 <br> 서울 동대문구 청계천로 521 다사랑행복센터 5층</div>',
										latlng : new kakao.maps.LatLng(
												37.571771, 127.034053)
									},
									{
										content : '<div class="infowbox">동작구수화통역센터 <br> 서울 동작구 만양로3길 14 3층</div>',
										latlng : new kakao.maps.LatLng(
												37.508016, 126.946957)
									},
									{
										content : '<div class="infowbox">마포구수화통역센터 <br> 서울 마포구 월드컵로 213 마포구장애인복지회관 3층</div>',
										latlng : new kakao.maps.LatLng(
												37.563725, 126.908856)
									},
									{
										content : '<div class="infowbox">서울시수화통역센터 지원본부 <br> 서울 서대문구 경기대로 15 엘림넷빌딩 3층 </div>',
										latlng : new kakao.maps.LatLng(
												37.560770, 126.961665)
									},
									{
										content : '<div class="infowbox">서대문구수화통역센터 <br> 서울 서대문구 통일로 344 무악청구아파트상가 201동 B105호</div>',
										latlng : new kakao.maps.LatLng(
												37.581994, 126.951889)
									},
									{
										content : '<div class="infowbox">서초구수화통역센터 <br> 서울 서초구 서운로23길 17 서초명달공원 경로당 내  </div>',
										latlng : new kakao.maps.LatLng(
												37.499011, 127.021114)
									},
									{
										content : '<div class="infowbox">성동수화센터 <br> 서울 성동구 청계천로 516 성동장애인생활회관 3층</div>',
										latlng : new kakao.maps.LatLng(
												37.570445, 127.033811)
									},
									{
										content : '<div class="infowbox ">성북수화통역센터 <br>서울 성북구 아리랑로4길 22 201호</div>',
										latlng : new kakao.maps.LatLng(
												37.594784, 127.017277)
									},
									{
										content : '<div class="infowbox">송파구수화통역센터<br>서울 송파구 문정로 13 선바위빌딩 5층</div>',
										latlng : new kakao.maps.LatLng(
												37.486382, 127.124250)
									},
									{
										content : '<div class="infowbox ">양천구수화통역센터 <br>서울 양천구 목동중앙북로 68 217호(목동, 목동에버하임)</div>',
										latlng : new kakao.maps.LatLng(
												37.547187, 126.870948)
									},
									{
										content : '<div class="infowbox ">영등포수화통역센터 <br>서울  영등포구 경인로 112길 13 금반석시티빌 9차 2층 </div>',
										latlng : new kakao.maps.LatLng(
												37.518120, 126.914234)
									},
									{
										content : '<div class="infowbox">용산구수화통역센터 <br>서울 용산구 서빙고로 245 장애인커뮤니티센터 4층 </div>',
										latlng : new kakao.maps.LatLng(
												37.520589, 126.991106)
									},
									{
										content : '<div class="infowbox">은평구수화통역센터 <br>서울 은평구 증산서길 82 2층 </div>',
										latlng : new kakao.maps.LatLng(
												37.583548, 126.906816)
									},
									{
										content : '<div class="infowbox ">종로구수화통역센터 <br>서울 종로구 종로17길 83층</div>',
										latlng : new kakao.maps.LatLng(
												37.570675, 126.988959)
									},
									{
										content : '<div class="infowbox">중구수화통역센터 <br>서울 중구 퇴계로20길 41-11 남산쉼터 2층</div>',
										latlng : new kakao.maps.LatLng(
												37.558734, 126.986775)
									},
									{
										content : '<div class="infowbox">중랑구수화통역센터 <br>서울 중랑구 면목로 299 6~7층</div>',
										latlng : new kakao.maps.LatLng(
					...
					<!--  P시작 -->
					<div class="bot">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="1400px" height="1400px" viewBox="0 0 1400 1400" enable-background="new 0 0 1400 1400" xml:space="preserve" class="Korea-svg">
  <g id="states">
  
 <path id="도봉구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M964.064,164.667
	...
	c7.441,0.328,14.299,0.634,21.004,1C944.035,158.024,948.826,166.568,964.064,164.667z" /></onclick="window.open('주소')">
    
    <path id="동대문구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M943.059,562.258
    ...
    <path id="동작구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M549.469,914.338
    ...
    <path id="은평구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M575.476,330.705
    ...
    <path id="강북구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M809.029,188.173
    ...
    <path id="강동구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M1169.111,741.299
    ...
    <path id="강서구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M134.875,530.751
    ...
    <path id="금천구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M409.438,1062.872
    ...
    <path id="구로구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M428.942,1040.367c0.317,1.684-0.644,4.645,0.5,5.501
    ...
    <path id="관악구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M694.002,1210.906
    ...
    <path id="광진구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M968.564,871.328
    ...
    <path id="강남구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M809.529,885.332
    ...
    <path id="종로구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M720.008,682.285
    ...
    <path id="중구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M852.039,722.795
    ...
    <path id="중랑구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M1120.1,474.238
    ...
    <path id="마포구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M402.936,583.763	c6.628,6.041,6.576,18.764,20.004,18.004c5.968,13.406,17.593,19.237,29.007,28.007c7.357,5.653,15.368,10.769,22.005,16.504	c12.672,10.951,22.254,25.911,33.508,36.008c5.59,5.017,12.528,8.948,18.004,14.503c2.292,2.709,4.792,5.21,7.502,7.501
    ...
    <path id="노원구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M1083.592,305.699
    ...
    <path id="서초구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M806.527,888.332	c4.836,12.346,15.342,23.65,19.506,37.509c1.785,5.944,2.385,13.452,3.5,20.005c1.16,6.825,0.615,14.923,3,20.504
    ...
    <path id="서대문구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M651.993,687.787
    ...
    <path id="성북구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M729.51,392.219
    ...
    <path id="성동구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M874.543,701.29c2.168,0,4.334,0,6.502,0
    ...
    <path id="송파구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M1142.104,808.314
    ...
    <path id="양천구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M199.39,804.313
    ...
    <path id="영등포구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M385.432,872.828
    ...
    <path id="용산구" fill-rule="evenodd" clip-rule="evenodd" fill="#C8C8C8" d="M737.012,767.305
...
<!-- <ul class="list-of-states">
  <li data-state="Dobong-gu">도봉구</li>
  <li data-state="Dongdaemun-gu">동대문구</li>
  <li data-state="Dongjak-gu">동작구</li>
  <li data-state="Eunpyeong-gu">은평구</li>
  <li data-state="Gangbuk-gu">강북구</li>
  <li data-state="Gangdong-gu">강동구</li>
  <li data-state="Gangseo-gu">강서구</li>
  <li data-state="Geumcheon-gu">금천구</li>
  <li data-state="Guro-gu">구로구</li>
  <li data-state="Gwanak-gu">관악구</li>
  <li data-state="Gwangjin-gu">광진구</li>
  <li data-state="Yongsan-gu">용산구</li>
  <li data-state="Gangnam-gu">강남구</li>
  <li data-state="Jongno-gu">종로구</li>
  <li data-state="Jung-gu">중구</li>
  <li data-state="Jungnang-gu">중랑구</li>
  <li data-state="Mapo-gu">마포구</li>
  <li data-state="Nowon-gu">노원구</li>
  <li data-state="Seocho-gu">서초구</li>
  <li data-state="Seodaemun-gu">서대문구</li>
  <li data-state="Seongbuk-gu">성북구</li>
  <li data-state="Seongdong-gu">성동구</li>
  <li data-state="Songpa-gu">송파구</li>
  <li data-state="Yangcheon-gu">양천구</li>
  <li data-state="Yeongdeungpo-gu_1_">영등포구</li>
  <li data-state="Yongsan-gu">용산구</li>
</ul> -->

<div id="Info" style="text-align:center;">
  <!-- ul > li 데이터를 받아와서 여기에다가 뿌려준다. -->
...
function mapButton(el){
      ...
      if(stateId=="강서구"){
      	window.open('http://ksdeaf.net/');
      } else if( stateId=="용산구" ) {
          window.open('https://blog.naver.com/ysdeaf');
      }  else if( stateId=="구로구" ) {
          window.open('http://www.gurodeaf.org/');
      }  else if( stateId=="은평구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2492&selectedBtn=16&statusStyle=number&localName=%EC%9D%80%ED%8F%89%EA%B5%AC');
      }  else if( stateId=="양천구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2502&selectedBtn=21&statusStyle=number&localName=%EC%96%91%EC%B2%9C%EA%B5%AC');
      }  else if( stateId=="중구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2460&selectedBtn=2&statusStyle=number&localName=%EC%A4%91%EA%B5%AC');
      }  else if( stateId=="성북구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2472&selectedBtn=7&statusStyle=number&localName=%EC%84%B1%EB%B6%81%EA%B5%AC');
      }  else if( stateId=="도봉구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2484&selectedBtn=12&statusStyle=number&localName=%EB%8F%84%EB%B4%89%EA%B5%AC');
      }  else if( stateId=="동대문구" ) {
          window.open('http://www.deafddm.com/');
      }  else if( stateId=="마포구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2504&selectedBtn=22&statusStyle=number&localName=%EB%A7%88%ED%8F%AC%EA%B5%AC');
      }  else if( stateId=="성동구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2464&selectedBtn=3&statusStyle=number&localName=%EC%84%B1%EB%8F%99%EA%B5%AC');
      }  else if( stateId=="서초구" ) {
          window.open('http://www.scdeaf.net/');
      }  else if( stateId=="중랑구" ) {
          window.open('https://cafe.naver.com/jndeaf');
      }  else if( stateId=="금천구" ) {
          window.open('http://cafe.daum.net/gcdeaf02');
      }  else if( stateId=="광진구" ) {
          window.open('https://cafe.naver.com/gjdeaf');
      }  else if( stateId=="관악구" ) {
          window.open('http://kadeaf.com/');
      }  else if( stateId=="강남구" ) {
         window.open('https://www.gangnam.go.kr/office/gndeaf/main.do');
      }  else if( stateId=="영등포구" ) {
          window.open('http://cafe.daum.net/yddeaf');
      }  else if( stateId=="종로구" ) {
          window.open('http://cafe.daum.net/jongno63');
      }  else if( stateId=="강동구" ) {
          window.open('https://cafe.naver.com/gddeaf');
      }  else if( stateId=="노원구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2468&selectedBtn=5&statusStyle=number&localName=%EB%85%B8%EC%9B%90%EA%B5%AC');
      }  else if( stateId=="강북구" ) {
          window.open('http://www.gbdeaf.or.kr/');
      } else if( stateId=="송파구" ) {
          window.open('http://cafe.daum.net/sp-deaf');
      } else if( stateId=="동작구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2500&selectedBtn=20&statusStyle=number&localName=%EB%8F%99%EC%9E%91%EA%B5%AC');
      } else if( stateId=="서대문구" ) {
          window.open('http://sdeaf.or.kr/?page_id=2510&selectedBtn=25&statusStyle=number&localName=%EC%84%9C%EB%8C%80%EB%AC%B8%EA%B5%AC');
      } else{
