...
async function onRefresh(chart) {
	...
	chart.config.data.datasets.forEach(function graph(dataset) {
		if(dataset.label=='정답'){
			dataset.data.push({
				x: Date.now(),
				y:  a
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcomb-list"
						style="background: #fff;  border-radius: 40px 40px 40px 40px; box-shadow: 0 6px 10px rgba(0, 0, 0, .08), 0 0 6px rgba(0, 0, 0, .05); transition: .3s transform cubic-bezier(.155, 1.105, .295, 1.12), .3s box-shadow, .3s -webkit-transform cubic-bezier(.155, 1.105, .295, 1.12);">
						<div class="row" style="text-align: center;">
							<h2>
								오늘의 수화는 <%=rDTO.getSign_name()%>
								 입니다!
							</h2>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
					<div
						...
						style="background-image:url('/img/side.png');background-size : cover;height:658.51px; border-radius: 20px; box-shadow: 0 6px 10px rgba(0, 0, 0, .08), 0 0 6px rgba(0, 0, 0, .05); transition: .3s transform cubic-bezier(.155, 1.105, .295, 1.12), .3s box-shadow, .3s -webkit-transform cubic-bezier(.155, 1.105, .295, 1.12); text-align: center;">
				...
				<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
					<div class="sale-statistic-inner notika-shadow mg-tb-30"
						style="height: 658.51px;  border-radius: 20px; background: #fff;background-image:url('/img/step1.jpg');background-size : cover; box-shadow: 0 6px 10px rgba(0, 0, 0, .08), 0 0 6px rgba(0, 0, 0, .05); transition: .3s transform cubic-bezier(.155, 1.105, .295, 1.12), .3s box-shadow, .3s -webkit-transform cubic-bezier(.155, 1.105, .295, 1.12); ">

							<button id="change1" class="btn btn-success notika-btn-success waves-effect" style="margin-top:550px; margin-left:300px;  background-color:#00c292;border: 0px; ">
							<i class="fas fa-share" style="font-weight:bold;"> STEP2 로 넘어가기</i>
							</button>
	...
	<div class="step2">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
					<div class="sale-statistic-inner notika-shadow mg-tb-30"
						style="height: 658.61px; background: #fff;background-image:url('/img/step2.jpg');background-size : cover; border-radius:20px; box-shadow: 0 6px 10px rgba(0, 0, 0, .08), 0 0 6px rgba(0, 0, 0, .05); transition: .3s transform cubic-bezier(.155, 1.105, .295, 1.12), .3s box-shadow, .3s -webkit-transform cubic-bezier(.155, 1.105, .295, 1.12); text-align: center;">

						

							<div id="video" class="video">
								
								<div style="margin-top: 130px;"><video src='<%=rDTO.getPath()%>' width="660px" height="400px" 
								controls></video></div>
							
                                <br><br>                         
								<button id="change2"
									class="btn btn-success notika-btn-success waves-effect"  style="background-color:#00c292;border: 0px; margin-left:2px; ">
									<i class="fas fa-share" style="font-weight:bold;"> STEP3로 넘어가기</i>
								</button>
							   </div>
                 ...
                 <div class="last">
                    ...
                    <br>
                     <canvas id="myChart" style="text-align: center; "></canvas>
                      ...
                      <br>   <br>                 
                        <div >
                        <button id="cha"  style=" background-color:#00c292;border: 0px;" class="btn btn-success notika-btn-success waves-effect" OnClick="location.href ='/user/login_register.do'">
							<i class="fas fa-share" style="font-weight:bold;" > 더 알아보기</i>
						</button>
						</div>
                    </div>
           <!--여까지 --  -->  
